...
public class XMLWriter extends XMLFilterImpl {
	...
	private Hashtable<String, Object> forcedDeclTable;
	 ...
	 * @param qName
	 *            The element's qualified (prefixed) name, or the empty string is
	 *            none is available. This method will use the qName as a template
	 *            for generating a prefix if necessary, but it is not guaranteed to
	 *            use the same qName.
	 * @param atts
	 *            The element's attribute list (must not be null).
	 * @exception org.xml.sax.SAXException
	 *                If there is an error writing the start tag, or if a handler
	 *                further down the filter chain raises an exception.
	 ...
	 *
	 * This method writes an empty element tag rather than a start tag followed by
	 * an end tag. Both a {@link #startElement startElement} and an
	 * {@link #endElement endElement} event will be passed on down the filter chain.
	 *
	 * @param uri
	 *            The element's Namespace URI, or the empty string if the element
	 *            has no Namespace or if Namespace processing is not being
	 *            performed.
	 * @param localName
	 *            The element's local name (without prefix). This parameter must be
	 *            provided.
	 * @param qName
	 *            The element's qualified name (with prefix), or the empty string if
	 *            none is available. This parameter is strictly advisory: the writer
	 *            may or may not use the prefix attached.
	 * @param atts
	 *            The element's attribute list.
	 * @exception org.xml.sax.SAXException
	 *                If there is an error writing the empty tag, or if a handler
	 *                further down the filter chain raises an exception.
	 * @see #startElement
	 * @see #endElement
	 */
	 ...
	 *
	 * <p>
	 * This method will supply an empty string for the qname and an empty attribute
	 * list. It invokes {@link #emptyElement(String, String, String, Attributes)}
	 * directly.
	 * </p>
	 *
	 * @param uri
	 ...
	 *
	 * <p>
	 * This method will supply an empty string for the qname, and empty string for
	 * the Namespace URI, and an empty attribute list. It invokes
	 ...
	 * @exception org.xml.sax.SAXException
	 *                If there is an error writing the characters, or if a handler
	 *                further down the filter chain raises an exception.
	 ...
	 *            The number of characters to write.
	 * @exception org.xml.sax.SAXException
	 *                If there is an error writing the whitespace, or if a handler
	 *                further down the filter chain raises an exception.
	 ...
	 *            The PI data.
	 * @exception org.xml.sax.SAXException
	 *                If there is an error writing the PI, or if a handler further
	 ...
	 *            The Namespace URI.
	 * @param qName
	 *            The qualified name (optional); this will be used to indicate the
	 *            preferred prefix if none is currently bound.
	 * @param isElement
	 *            true if this is an element name, false if it is an attribute name
	 *            (which cannot use the default Namespace).
	 */
	private String doPrefix(String uri, String qName, boolean isElement) {
		...
		prefix = calculatePrefix(uri, defaultNS, qName, isElement);
	...
	private String calculatePrefix(String uri, String defaultNS, String qName, boolean isElement) {
		String prefix = doneDeclTable.get(uri);
		if (prefix != null
	 ...
	 * @exception org.xml.sax.SAXException
	 *                If there is an error writing the character, this method will
	 ...
	 *                If there is an error writing the attribute list, this method
	 ...
	 * @exception org.xml.SAXException
	 *                If there is an error writing the characters, this method will
	 *                throw an IOException wrapped in a SAXException.
	 */
